...
DocumentReference? get currentUserReference =>
    loggedIn ? EntregadorRecord.collection.doc(currentUser!.uid) : null;

EntregadorRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : EntregadorRecord.getDocument(EntregadorRecord.collection.doc(uid))
              .handleError((_) {}),
    )
